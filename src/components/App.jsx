...
function App() {
    ...
    return (
      <div>
        ...
        <br />
        <button className="speed" onClick={ () => dispatch({ type: "SpeedUp"}) }>Speed up</button>
        <button className="speed" onClick={ () => dispatch({ type: "SpeedDown"}) }>Speed down</button>
        <hr />
        <h1>
